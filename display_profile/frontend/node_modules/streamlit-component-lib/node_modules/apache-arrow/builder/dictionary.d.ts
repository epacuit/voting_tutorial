...
import { IntBuilder } from 'streamlit-component-lib/node_modules/apache-arrow/builder/int';
import { Dictionary, DataType } from 'streamlit-component-lib/node_modules/apache-arrow/type';
import { Builder, BuilderOptions } from 'streamlit-component-lib/node_modules/apache-arrow/builder';
...
export declare class DictionaryBuilder<T extends Dictionary, TNull = any> extends Builder<T, TNull> {
    ...
    flush(): import("streamlit-component-lib/node_modules/apache-arrow/data").Data<T>;
    finish(): this;
    clear(): this;
