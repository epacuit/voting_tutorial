...
import { BuilderType as B, VectorType as V } from 'streamlit-component-lib/node_modules/apache-arrow/interfaces';
import { BufferBuilder, BitmapBufferBuilder, DataBufferBuilder, OffsetsBufferBuilder } from 'streamlit-component-lib/node_modules/apache-arrow/builder/buffer';
import { DataType, Float, Int, Decimal, FixedSizeBinary, Date_, Time, Timestamp, Interval, Utf8, Binary, List, Map_ } from 'streamlit-component-lib/node_modules/apache-arrow/type';
/**
...
export declare abstract class Builder<T extends DataType = any, TNull = any> {
    ...
    /** @nocollapse */
    static throughNode<T extends DataType = any, TNull = any>(options: import('streamlit-component-lib/node_modules/apache-arrow/io/node/builder').BuilderDuplexOptions<T, TNull>): import('stream').Duplex;
    /** @nocollapse */
    static throughDOM<T extends DataType = any, TNull = any>(options: import('streamlit-component-lib/node_modules/apache-arrow/io/whatwg/builder').BuilderTransformOptions<T, TNull>): import('streamlit-component-lib/node_modules/apache-arrow/io/whatwg/builder').BuilderTransform<T, TNull>;
    /**
